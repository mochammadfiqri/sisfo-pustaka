    ...
    <main id="main">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p class="text-justify">
                            Menempatkan diri saya sebagai seorang profesional IT yang berkualitas tinggi dengan keahlian dalam memperbaiki komputer, instalasi jaringan, dan pengetahuan dasar tentang pengembangan menggunakan framework Laravel.
                        </p>
                        <ul>
                            <li><i class="ri-check-double-line"></i> Merakit Komputer</li>
                            <li><i class="ri-check-double-line"></i> Memperbaiki Komputer</li>
                            <li><i class="ri-check-double-line"></i> Instalasi Jaringan</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p class="text-justify">
                            Saya bertujuan untuk menerapkan keahlian saya dalam memecahkan masalah IT dengan efisiensi tinggi, mengoptimalkan
                            kinerja sistem, dan memberikan solusi yang inovatif untuk mendukung keberhasilan perusahaan.
                        </p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-1.jpg') }}" class="img-fluid" alt="">
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-2.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>Web 3</h4>
                            <p>Web</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-3.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>App 2</h4>
                            <p>App</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-4.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>Card 2</h4>
                            <p>Card</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-5.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>Web 2</h4>
                            <p>Web</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-6.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>App 3</h4>
                            <p>App</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-7.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>Card 1</h4>
                            <p>Card</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-8.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>Card 3</h4>
                            <p>Card</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-img"><img src="{{ asset('img/portfolio/portfolio-9.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="portfolio-info">
                            <h4>Web 3</h4>
                            <p>Web</p>
        ...
        <section id="booklist" class="booklist">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Daftar Buku</h2>
                    <p>Di sini, Anda akan menemukan koleksi lengkap dan beragam dari buku-buku terbaru, klasik, dan favorit, yang dikurasi
                    dengan seksama untuk memenuhi berbagai selera pembaca. Dari fiksi hingga non-fiksi, dari kisah-kisah petualangan hingga
                    panduan praktis, kami menyajikan daftar buku yang menarik dan bermanfaat bagi semua kalangan.</p>
                </div>
                    ...
                    @foreach ($books as $item)
                        <div class="col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="box">
                                ...
                                <p class="card-text">{{ $item->abstrak }}</p>
