 ...
 *   https://datatables.net/download/#ju-1.13.2/dt-1.13.4/af-2.5.3/b-2.3.6/cr-1.6.2/date-1.4.0/fc-4.2.2/fh-3.3.2/kt-2.8.2/r-2.4.1/rg-1.3.1/rr-1.3.3/sc-2.1.1/sb-1.4.1/sp-2.1.2/sl-1.6.2/sr-1.2.2
 *
 * Included libraries:
 *   jQuery UI 1.13.2, DataTables 1.13.4, AutoFill 2.5.3, Buttons 2.3.6, ColReorder 1.6.2, DateTime 1.4.0, FixedColumns 4.2.2, FixedHeader 3.3.2, KeyTable 2.8.2, Responsive 2.4.1, RowGroup 1.3.1, RowReorder 1.3.3, Scroller 2.1.1, SearchBuilder 1.4.1, SearchPanes 2.1.2, Select 1.6.2, StateRestore 1.2.2
 */
