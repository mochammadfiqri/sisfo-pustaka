...
class PengembalianExport implements FromQuery, WithMapping, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    public function query() {
        return Rentlogs::select('user_id', 'book_id', 'return_date');
    }
    ...
    public function map($RentLogs): array {
        return [
            ...
            $RentLogs->Book->judul,
            Carbon::parse($RentLogs->return_date)->formatLocalized('%d %B %Y')
        ];
    }
}
